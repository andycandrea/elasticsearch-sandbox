...
Zlib::GzipReader.open(File.expand_path('articles.yml.gz', __dir__)) do |gzip|
...
Article.__elasticsearch__.client.transport.tracer.formatter = ->(_s, _d, _p, message) do
